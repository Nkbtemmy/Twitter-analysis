...
// const { unzipFile } = require("./fileExtractor.ts");
// const fs = require("fs");

// module.exports = () => {

// 	// Example usage:
// 	const zipFilePath = path.join(__dirname, 'files', './src/utils/helpers/files/query2_ref.zip');
// 	const outputFolderPath = path.join(__dirname, 'files', 'unzipped');
...
// 	const raw = fs
// 		.readFileSync(path.join(__dirname, `${unzippedFolderPath}/query2_ref.txt`))
// 		.toString();
